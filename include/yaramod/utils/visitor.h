...
public:
	...
	virtual VisitResult visit(IcontainsExpression* expr) = 0;
	virtual VisitResult visit(MatchesExpression* expr) = 0;
	virtual VisitResult visit(StartsWithExpression* expr) = 0;
	virtual VisitResult visit(IstartsWithExpression* expr) = 0;
	virtual VisitResult visit(EndsWithExpression* expr) = 0;
	virtual VisitResult visit(IendsWithExpression* expr) = 0;
	...
	virtual VisitResult visit(ForDictExpression* expr) = 0;
