...
rule rule_with_regexp {
    ...
    condition:
        ...
        self.assertEqual(len(regexp_string.modifiers), 0)
...
rule rule_with_complex_regexp {
    ...
    condition:
        ...
        self.assertEqual(regexp_string.suffix_modifiers, '')
        self.assertEqual(len(regexp_string.modifiers), 4)
...
rule rule_with_regexp_suffix_modifiers {
    ...
    condition:
        ...
        self.assertEqual(len(rule.strings[1].modifiers), 0)
        ...
        self.assertEqual(len(rule.strings[2].modifiers), 0)
        ...
        self.assertEqual(len(rule.strings[3].modifiers), 4)
        ...
        self.assertEqual(len(rule.strings[4].modifiers), 4)
