...
bool PhishModule::initialize()
{
	...
	aStruct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	aStruct->addAttribute(std::make_shared<ValueSymbol>("hrefs_hashed", Type::String));
	...
	aStruct->addAttribute(std::make_shared<ValueSymbol>("ids_hashed", Type::String));
	...
	aStruct->addAttribute(std::make_shared<ValueSymbol>("styles_hashed", Type::String));
	...
	aStruct->addAttribute(std::make_shared<ValueSymbol>("texts_hashed", Type::String));
	...
	buttonStruct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	buttonStruct->addAttribute(std::make_shared<ValueSymbol>("ids_hashed", Type::String));
	...
	buttonStruct->addAttribute(std::make_shared<ValueSymbol>("onclicks_hashed", Type::String));
	...
	commentStruct->addAttribute(std::make_shared<ValueSymbol>("texts_hashed", Type::String));
	...
	divStruct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	divStruct->addAttribute(std::make_shared<ValueSymbol>("ids_hashed", Type::String));
	...
	formStruct->addAttribute(std::make_shared<ValueSymbol>("actions_hashed", Type::String));
	...
	formStruct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	formStruct->addAttribute(std::make_shared<ValueSymbol>("methods_hashed", Type::String));
	...
	formStruct->addAttribute(std::make_shared<ValueSymbol>("names_hashed", Type::String));
	...
	h1Struct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	h1Struct->addAttribute(std::make_shared<ValueSymbol>("texts_hashed", Type::String));
	...
	h2Struct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	h2Struct->addAttribute(std::make_shared<ValueSymbol>("texts_hashed", Type::String));
	...
	iframeStruct->addAttribute(std::make_shared<ValueSymbol>("widths_hashed", Type::String));
	...
	iframeStruct->addAttribute(std::make_shared<ValueSymbol>("heights_hashed", Type::String));
	...
	iframeStruct->addAttribute(std::make_shared<ValueSymbol>("srcs_hashed", Type::String));
	...
	iframeStruct->addAttribute(std::make_shared<ValueSymbol>("styles_hashed", Type::String));
	...
	iframeStruct->addAttribute(std::make_shared<ValueSymbol>("names_hashed", Type::String));
	...
	imgStruct->addAttribute(std::make_shared<ValueSymbol>("alts_hashed", Type::String));
	...
	imgStruct->addAttribute(std::make_shared<ValueSymbol>("srcs_hashed", Type::String));
	...
	inputStruct->addAttribute(std::make_shared<ValueSymbol>("ids_hashed", Type::String));
	...
	inputStruct->addAttribute(std::make_shared<ValueSymbol>("names_hashed", Type::String));
	...
	inputStruct->addAttribute(std::make_shared<ValueSymbol>("placeholders_hashed", Type::String));
	...
	inputStruct->addAttribute(std::make_shared<ValueSymbol>("srcs_hashed", Type::String));
	...
	inputStruct->addAttribute(std::make_shared<ValueSymbol>("types_hashed", Type::String));
	...
	inputStruct->addAttribute(std::make_shared<ValueSymbol>("values_hashed", Type::String));
	...
	linkStruct->addAttribute(std::make_shared<ValueSymbol>("hrefs_hashed", Type::String));
	...
	linkStruct->addAttribute(std::make_shared<ValueSymbol>("rels_hashed", Type::String));
	...
	linkStruct->addAttribute(std::make_shared<ValueSymbol>("types_hashed", Type::String));
	...
	metaTagStruct->addAttribute(std::make_shared<ValueSymbol>("contents_hashed", Type::String));
	...
	metaTagStruct->addAttribute(std::make_shared<ValueSymbol>("names_hashed", Type::String));
	...
	metaTagStruct->addAttribute(std::make_shared<ValueSymbol>("properties_hashed", Type::String));
	...
	scriptStruct->addAttribute(std::make_shared<ValueSymbol>("srcs_hashed", Type::String));
	scriptStruct->addAttribute(std::make_shared<FunctionSymbol>("text_partial_hash", Type::Int, Type::String));
	scriptStruct->addAttribute(std::make_shared<ValueSymbol>("texts_hashed", Type::String));
	scriptStruct->addAttribute(std::make_shared<ValueSymbol>("text_lengths_hashed", Type::String));
	...
	scriptStruct->addAttribute(std::make_shared<ValueSymbol>("types_hashed", Type::String));
	...
	spanStruct->addAttribute(std::make_shared<ValueSymbol>("classes_hashed", Type::String));
	...
	styleStruct->addAttribute(std::make_shared<ValueSymbol>("texts_hashed", Type::String));
	styleStruct->addAttribute(std::make_shared<ValueSymbol>("text_lengths_hashed", Type::String));
	...
	styleStruct->addAttribute(std::make_shared<ValueSymbol>("types_hashed", Type::String));
	...
	urlAnalysisStruct->addAttribute(std::make_shared<ValueSymbol>("domain_key_words_hashed", Type::String));
	...
	urlAnalysisStruct->addAttribute(std::make_shared<ValueSymbol>("path_key_words_hashed", Type::String));
	...
	urlAnalysisStruct->addAttribute(std::make_shared<ValueSymbol>("url_sequences_hashed", Type::String));
