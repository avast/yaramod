...
void initializeCommonAttributes(const std::shared_ptr<StructureSymbol>& rootStruct)
{
	...
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("segname", Type::String));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("vmaddr", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("vmsize", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("fileoff", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("fsize", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("maxprot", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("initprot", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("nsects", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("flags", Type::Int));
	auto sectionsStruct = std::make_shared<StructureSymbol>("sections");
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("sectname", Type::String));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("segname", Type::String));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("addr", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("size", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("offset", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("align", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("reloff", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("nreloc", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("flags", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("reserved1", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("reserved2", Type::Int));
	rootStruct->addAttribute(std::make_shared<ValueSymbol>("reserved3", Type::Int));
