...
bool DexModule::initialize()
{
	...
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("magic", Type::String));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("checksum", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("signature", Type::String));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("file_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("header_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("endian_tag", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("link_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("link_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("map_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("string_ids_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("string_ids_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("type_ids_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("type_ids_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("proto_ids_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("proto_ids_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("field_ids_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("field_ids_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("method_ids_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("method_ids_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("class_defs_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("class_defs_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("data_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("data_offset", Type::Int));
	dexStruct->addAttribute(headerStruct);

	auto stringIdsStruct = std::make_shared<StructureSymbol>("string_ids");
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("value", Type::String));
	...
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("descriptor_idx", Type::Int));
	...
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("shorty_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("return_type_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("parameters_offset", Type::Int));
	...
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("class_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("type_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("name_idx", Type::Int));
	...
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("class_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("access_flags", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("superclass_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("interfaces_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("source_file_idx", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("annotations_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("class_data_offset", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("static_values_offset", Type::Int));
	...
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("static_fields_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("instance_fields_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("direct_methods_size", Type::Int));
	dexStruct->addAttribute(std::make_shared<ValueSymbol>("virtual_methods_size", Type::Int));
