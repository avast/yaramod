 ...
 */
YaraHexStringBuilder::YaraHexStringBuilder(std::shared_ptr<TokenStream>& ts)
	: _tokenStream(ts)
{
}
 ...
 */
std::shared_ptr<HexString> YaraHexStringBuilder::get(std::shared_ptr<TokenStream> acceptor /*= nullptr*/, bool addHexParentheses /*= true*/) const
{
