...
public:
	...
	PURE_VISIT(PercentualExpression)
	...
	PURE_VISIT(IcontainsExpression)
	PURE_VISIT(IendsWithExpression)
	PURE_VISIT(IequalsExpression)
	PURE_VISIT(IstartsWithExpression)
	PURE_VISIT(StartsWithExpression)
	PURE_VISIT(EndsWithExpression)
...
public:
	...
	VISIT(ObservingVisitor, PercentualExpression)
	...
	VISIT(ObservingVisitor, IcontainsExpression)
	VISIT(ObservingVisitor, IendsWithExpression)
	VISIT(ObservingVisitor, IequalsExpression)
	VISIT(ObservingVisitor, IstartsWithExpression)
	VISIT(ObservingVisitor, StartsWithExpression)
	VISIT(ObservingVisitor, EndsWithExpression)
	...
	VISIT(ObservingVisitor, NoneExpression)
...
public:
	...
	VISIT(ModifyingVisitor, PercentualExpression)
	...
	VISIT(ModifyingVisitor, IcontainsExpression)
	VISIT(ModifyingVisitor, IendsWithExpression)
	VISIT(ModifyingVisitor, IequalsExpression)
	VISIT(ModifyingVisitor, IstartsWithExpression)
	VISIT(ModifyingVisitor, StartsWithExpression)
	VISIT(ModifyingVisitor, EndsWithExpression)
	...
	VISIT(ModifyingVisitor, NoneExpression)
