...
class Expression:
    ...
    def clone(self, arg0: TokenStream) -> None: ...
...
class ModifyingVisitor(Visitor):
    ...
    def visit_VariableDefExpression(self, arg0: VariableDefExpression) -> Union[Expression,VisitAction]: ...
    def visit_WithExpression(self, arg0: WithExpression) -> Union[Expression,VisitAction]: ...
...
class YaraExpressionBuilder:
    ...
    def __eq__(self, arg0: YaraExpressionBuilder) -> YaraExpressionBuilder: ...  # type: ignore
    ...
    def __ne__(self, arg0: YaraExpressionBuilder) -> YaraExpressionBuilder: ...  # type: ignore
...
class Yaramod:
    def __init__(self, import_features: Features = ..., modules_directory: str = ...) -> None: ...
    def parse_file(self, file_path: str, parser_mode: ParserMode = ...) -> Optional[YaraFile]: ...
    def parse_string(self, str: str, parser_mode: ParserMode = ...) -> Optional[YaraFile]: ...
    @property
