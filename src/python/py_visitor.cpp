...
void addVisitorClasses(py::module& module)
{
	...
	py::class_<ModifyingVisitor, PyModifyingVisitor, Visitor>(module, "ModifyingVisitor")
		...
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(StringAtExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(StringInRangeExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(StringOffsetExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(StringLengthExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(NotExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(UnaryMinusExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(BitwiseNotExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, AndExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, OrExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, LtExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, GtExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, LeExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, GeExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, EqExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, NeqExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, ContainsExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, MatchesExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, PlusExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, MinusExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, MultiplyExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, DivideExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, ModuloExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, BitwiseXorExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, BitwiseAndExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, BitwiseOrExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, ShiftLeftExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(TokenStreamContext&, ShiftRightExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(ForIntExpression*, const VisitResult&, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(ForStringExpression*, const VisitResult&, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(OfExpression*, const VisitResult&, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(SetExpression*, const std::vector<VisitResult>&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(RangeExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(StructAccessExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(ArrayAccessExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(FunctionCallExpression*, const VisitResult&, const std::vector<VisitResult>&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(ParenthesesExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(IntFunctionExpression*, const VisitResult&)>(&ModifyingVisitor::defaultHandler));
}
