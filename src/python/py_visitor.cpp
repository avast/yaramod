...
void addVisitorClasses(py::module& module)
{
	...
	py::class_<Visitor, PyVisitor>(module, "Visitor")
		...
		.def("visit_OfInRangeExpression", py::overload_cast<OfInRangeExpression*>(&Visitor::visit))
	...
	py::class_<ObservingVisitor, PyObservingVisitor, Visitor>(module, "ObservingVisitor")
		...
		.def("visit_OfInRangeExpression", py::overload_cast<OfInRangeExpression*>(&ObservingVisitor::visit))
	...
	py::class_<ModifyingVisitor, PyModifyingVisitor, Visitor>(module, "ModifyingVisitor")
		...
		.def("visit_OfInRangeExpression", py::overload_cast<OfInRangeExpression*>(&ModifyingVisitor::visit))
		...
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, OfInRangeExpression*, const VisitResult&, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
