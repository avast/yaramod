...
void addVisitorClasses(py::module& module)
{
	...
	py::class_<ModifyingVisitor, PyModifyingVisitor, Visitor>(module, "ModifyingVisitor")
		...
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(StringAtExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(StringInRangeExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(StringOffsetExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(StringLengthExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(NotExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(UnaryMinusExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(BitwiseNotExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(AndExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(OrExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(LtExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(GtExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(LeExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(GeExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(EqExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(NeqExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ContainsExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(MatchesExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(PlusExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(MinusExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(MultiplyExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(DivideExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ModuloExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(BitwiseXorExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(BitwiseAndExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(BitwiseOrExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ShiftLeftExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ShiftRightExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ForIntExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ForStringExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(OfExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(SetExpression*, const std::vector<Visitee::ReturnType>&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(RangeExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(StructAccessExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ArrayAccessExpression*, const Visitee::ReturnType&, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(FunctionCallExpression*, const Visitee::ReturnType&, const std::vector<Visitee::ReturnType>&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(ParenthesesExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<Visitee::ReturnType(ModifyingVisitor::*)(IntFunctionExpression*, const Visitee::ReturnType&)>(&ModifyingVisitor::defaultHandler));
}
