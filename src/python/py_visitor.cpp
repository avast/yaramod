...
void addVisitorClasses(py::module& module)
{
	...
	py::class_<Visitor, PyVisitor>(module, "Visitor")
		...
		.def("visit_IcontainsExpression", py::overload_cast<IcontainsExpression*>(&Visitor::visit))
		.def("visit_IendsWithExpression", py::overload_cast<IendsWithExpression*>(&Visitor::visit))
		.def("visit_IequalsExpression", py::overload_cast<IequalsExpression*>(&Visitor::visit))
		.def("visit_IstartsWithExpression", py::overload_cast<IstartsWithExpression*>(&Visitor::visit))
		.def("visit_StartsWithExpression", py::overload_cast<StartsWithExpression*>(&Visitor::visit))
		.def("visit_EndsWithExpression", py::overload_cast<EndsWithExpression*>(&Visitor::visit))
	...
	py::class_<ObservingVisitor, PyObservingVisitor, Visitor>(module, "ObservingVisitor")
		...
		.def("visit_IcontainsExpression", py::overload_cast<IcontainsExpression*>(&ObservingVisitor::visit))
		.def("visit_IendsWithExpression", py::overload_cast<IendsWithExpression*>(&ObservingVisitor::visit))
		.def("visit_IequalsExpression", py::overload_cast<IequalsExpression*>(&ObservingVisitor::visit))
		.def("visit_IstartsWithExpression", py::overload_cast<IstartsWithExpression*>(&ObservingVisitor::visit))
		.def("visit_StartsWithExpression", py::overload_cast<StartsWithExpression*>(&ObservingVisitor::visit))
		.def("visit_EndsWithExpression", py::overload_cast<EndsWithExpression*>(&ObservingVisitor::visit))
	...
	py::class_<ModifyingVisitor, PyModifyingVisitor, Visitor>(module, "ModifyingVisitor")
		...
		.def("visit_IcontainsExpression", py::overload_cast<IcontainsExpression*>(&ModifyingVisitor::visit))
		.def("visit_IendsWithExpression", py::overload_cast<IendsWithExpression*>(&ModifyingVisitor::visit))
		.def("visit_IequalsExpression", py::overload_cast<IequalsExpression*>(&ModifyingVisitor::visit))
		.def("visit_IstartsWithExpression", py::overload_cast<IstartsWithExpression*>(&ModifyingVisitor::visit))
		.def("visit_StartsWithExpression", py::overload_cast<StartsWithExpression*>(&ModifyingVisitor::visit))
		.def("visit_EndsWithExpression", py::overload_cast<EndsWithExpression*>(&ModifyingVisitor::visit))
		...
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, IcontainsExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, IendsWithExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		...
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, IstartsWithExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, StartsWithExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, EndsWithExpression*, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
		...
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, OfExpression*, const VisitResult&, const VisitResult&, const VisitResult&, const VisitResult&)>(&ModifyingVisitor::defaultHandler))
