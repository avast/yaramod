...
void addVisitorClasses(py::module& module)
{
	...
	py::class_<Visitor, PyVisitor>(module, "Visitor")
		...
		.def("visit_IteratorExpression", py::overload_cast<IteratorExpression*>(&Visitor::visit))
	...
	py::class_<ObservingVisitor, PyObservingVisitor, Visitor>(module, "ObservingVisitor")
		...
		.def("visit_IteratorExpression", py::overload_cast<IteratorExpression*>(&ObservingVisitor::visit))
	...
	py::class_<ModifyingVisitor, PyModifyingVisitor, Visitor>(module, "ModifyingVisitor")
		...
		.def("visit_IteratorExpression", py::overload_cast<IteratorExpression*>(&ModifyingVisitor::visit))
		...
		.def("default_handler", static_cast<VisitResult(ModifyingVisitor::*)(const TokenStreamContext&, IteratorExpression*, const std::vector<VisitResult>&)>(&ModifyingVisitor::defaultHandler))
